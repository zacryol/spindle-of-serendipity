...
godot-3.2.3 --path godot --export "Linux/X11" ../export/lin/spindle-of-serendipity.x86_64

echo Exporting Windows build
godot-3.2.3 --path godot --export "Windows Desktop" ../export/win/spindle-of-serendipity.exe

echo Exporting Mac build
godot-3.2.3 --path godot --export "Mac OSX" ../export/mac/spindle-of-serendipity-mac.zip
